...
export default function FakeNotesPage() {
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center px-4 pt-14 pb-2 bg-[#000000]">
        
        {/* Bare Chevron Back Button (No background circle) */}
        <div 
          onClick={() => router.push('/')} 
          className="flex items-center text-[#E5C02A] cursor-pointer"
        >
          <svg className="w-7 h-7 ml-[-6px]" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
        ...
        <div className="flex items-center space-x-2">
          {/* Undo Button */}
          <div className="flex items-center justify-center w-8 h-8 rounded-full bg-[#1C1C1E] text-gray-300">
          ...
          <button 
            ...
            className="flex items-center justify-center w-8 h-8 rounded-full bg-[#1C1C1E] text-gray-300 active:scale-95 transition-transform"
          >
            {status === 'sent' ? (
              <span className="text-[10px] font-bold text-[#E5C02A]">✓✓</span>
            ) : (
      ...
      <div className="absolute bottom-8 left-0 right-0 px-4 flex justify-between items-end pointer-events-none">
        ...
        {/* Left Floating Pill (Checklist, Paperclip, Markup) */}
        <div className="flex items-center space-x-6 bg-[#2C2C2E]/90 backdrop-blur-lg rounded-full px-5 py-3 pointer-events-auto">
          {/* Checklist Icon */}
        ...
        <div className="flex items-center justify-center w-12 h-12 rounded-full bg-[#2C2C2E]/90 backdrop-blur-lg pointer-events-auto">
